...
/**
 * Nova Aula — Versão final "uma tela só" (sem wizard).
 * Tudo numa rolagem: Tipo · Quando · O que treinou · O que foi passado (texto +
 * ditado por voz via MicButton existente) · Quem veio. "Salvar aula" fixo embaixo.
 *
 * Reaproveita o MicButton do projeto (Web Speech API — ditado sem IA).
 * Mantém o mesmo POST /api/aulas do wizard antigo.
 */
  ...
  return (
    <div className="flex h-[100dvh] flex-col overflow-hidden bg-background">
      ...
      <header className="flex h-14 shrink-0 items-center gap-3 border-b border-border px-4">
        ...
        <h1 className="flex-1 text-lg font-extrabold tracking-tight">Nova aula</h1>
      </header>
